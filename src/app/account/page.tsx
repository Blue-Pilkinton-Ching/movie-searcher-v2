    ...
    <div>
      {userLoading || loading ? (
        ...
        <>
          {user ? (
            <>
              ...
              <p className="text-sm max-w-[350px] py-2 text-neutral-500">
                The extra servers may create NSFW popup ads. We advise you
                install an{' '}
                <Link
            ...
            <>
              ...
              <p className="text-sm max-w-[350px] py-2">
                Creating an account allows you to view recently watched media,
                and create movie lists! You also won&apos;t receive junk mail,
                ads or other crap.
              </p>
            </>
          )}
          ...
          <a
            href="https://buymeacoffee.com/watchalot"
            className={`shadow-md bg-[#FFDD00] text-black mt-3 font-bold w-[90vw] max-w-[350px] h-10 items-center active:scale-95 rounded-xl px-5 py-1 hover:brightness-75 duration-200 flex`}
            target="_blank"
          >
            <svg
            ...
            <div className="text-lg text-center w-full">Buy Me a Coffee</div>
          </a>
          <p className="text-sm max-w-[350px] py-2">
